...
class TestRuntimeConfig(unittest.TestCase):
    def test_no_control_room_keeps_startup_config(self) -> None:
        ...
        self.assertEqual(len(bot.toolbox.specs()), 10)  # 全部 10 个(+list_capabilities/assemble_team)
    ...
    def test_tool_toggle_filters_specs(self) -> None:
        ...
        self.assertEqual(
            names,
            ["create_room", "create_tasks", "search_knowledge", "web_search", "list_capabilities", "assemble_team"],
        )  # always-on 不受开关约束
