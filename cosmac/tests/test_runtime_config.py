...
class TestRuntimeConfig(unittest.TestCase):
    def test_no_control_room_keeps_startup_config(self) -> None:
        ...
        self.assertEqual(len(bot.toolbox.specs()), 9)  # 全部 9 个(含 search_knowledge/web_search/list_capabilities)
    ...
    def test_tool_toggle_filters_specs(self) -> None:
        ...
        self.assertEqual(
            names,
            ["create_room", "create_tasks", "search_knowledge", "web_search", "list_capabilities"],
        )  # always-on 不受开关约束
