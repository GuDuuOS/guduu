...
export const pluginItems: PluginStoreItem[] = [
  /* AI 工具 */
  { id: 'main-ai', name: 'CosMac Star Main AI · 安其', cat: 'ai', author: 'CosMac Star 官方', desc: '右侧栏常驻主控 AI，可建群、自动拉人、查询工作室任务状态', installs: '12k', price: 0, icon: 'AI', color: '#c96442', tag: '内置', builtinPluginId: 'ai', installed: true },
